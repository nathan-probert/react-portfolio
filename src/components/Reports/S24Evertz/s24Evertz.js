...
const S24Evertz = () => {
    return (
        ...
        <section className="blog-section">
          ...
          <p className="content">
            &emsp;During the summer of 2024, I worked as a Software Developer Intern at Evertz Microsystems Ltd. in Burlington, Ontario. This report provides an overview of the organization, outlines my personal learning goals, and details my responsibilities and achievements during this work term.
          </p>
        </section>
        <section className="blog-section">
          ...
          <p className="content">
            ...
            &emsp;Evertz.io is a Software as a Service platform that allows cloud video services for content owners and creators. This service fully manages platform maintenance, backend engineering, and cloud scaling, alowing customers to focus their resources entirely on operations.
          </p>
          <br />
        ...
        <section className="blog-section">
          ...
          &emsp;Git is a well-known control system that is used by many companies. While I have used Git before for school and personal use, I've never fully been able to use Git to its full potential. As I use GitHub at Evertz, I made it a goal of mine to develop a better understanding by attending Git seminars and doing my own research.<br /><br />
          &emsp;I feel much more comfortable now navigating branches, pull requests, and handling merge conflicts, none of which I was able to do before my time at Evertz. This is an extremely essential skill as it is something I would be expected to know going forward, and also very important in managing my own projects.<br /><br /> 

          <h3>&emsp;-&emsp;Learn about working with API's and Postman effectively<br /></h3>
          &emsp;API's (and Websockets) are arguably the backbone of backend services. I had very little experience with API's and none with Postman going in, so I felt it was important to learn about these technologies so that I can become more effective and build new things.<br /><br />
          ...
          &emsp;Although the title is general, one of my main goals is simply developing better problem solving skills. Evertz is my first professional programming job, and the first time I am working on a code base that is not my own. I wanted to reach a point where I can be given a task or discover a bug, then create and implement a solution without any assistance.<br /><br />
          &emsp;Throughout my work term, I got more and more comfortable working with the code base and understanding how all the different microservices worked together. I was able to effectively troubleshoot any bugs, and I could generally complete tasks without assistance.<br /><br /> 
          </p>
        </section>
        <section className="blog-section">
